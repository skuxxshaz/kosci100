...
export interface PlanSession {
  ...
  label: string;
  targetKm?: number;
  targetMin?: number; // only used for non-run sessions now (bike, stair)
}
...
export const PLAN: PlanPhase[] = [
    ...
    weeks: [
      {
        ...
        sessions: [
          ...
          { date: "2026-09-25", type: "bike", label: "Rouvy Zone2", targetMin: 50 },
          { date: "2026-09-26", type: "gymL", label: "Gym – full body, light" },
  ...
  },
  {
    ...
    name: "Build 1",
    range: "28 Sep – 18 Oct",
    note: "Rebuild volume, extend the long run, bring stairmaster back as dedicated vert training. The 60km/week marathon base means volume can climb faster than a from-scratch base phase would allow.",
    weeks: [
      {
        id: "w5",
        label: "Week 5",
        ...
        weeklyKmGoal: 48.5,
        sessions: [
          { date: "2026-09-28", type: "gymL", label: "Gym – Lower" },
          { date: "2026-09-29", type: "run", label: "Tempo run (2.5km easy / 4.5km tempo / 2.5km easy)", targetKm: 9.5 },
          { date: "2026-09-30", type: "bike", label: "Rouvy Zone2", targetMin: 60 },
          { date: "2026-10-01", type: "gymU", label: "Gym – Upper" },
          { date: "2026-10-02", type: "stair", label: "Stairmaster, steady", targetMin: 40 },
          { date: "2026-10-02", type: "run", label: "Short easy run", targetKm: 4 },
          { date: "2026-10-03", type: "swim", label: "Recovery swim", targetKm: 1 },
          { date: "2026-10-04", type: "long", label: "Long trail run, moderate vert", targetKm: 27 },
        ],
      },
      {
        id: "w6",
        ...
        sessions: [
          ...
          { date: "2026-10-06", type: "gymL", label: "Gym – Lower" },
          { date: "2026-10-07", type: "run", label: "Easy run", targetKm: 11 },
          { date: "2026-10-08", type: "bike", label: "Rouvy Zone2", targetMin: 75 },
          { date: "2026-10-09", type: "gymU", label: "Gym – Upper" },
          { date: "2026-10-09", type: "swim", label: "Swim", targetKm: 1 },
          { date: "2026-10-10", type: "stair", label: "Stairmaster, repeats", targetMin: 45 },
          { date: "2026-10-10", type: "run", label: "Short easy run", targetKm: 4 },
          { date: "2026-10-11", type: "long", label: "Long trail run, vert focus", targetKm: 30 },
        ],
      },
      {
        id: "w7",
        ...
        sessions: [
          ...
          { date: "2026-10-13", type: "gymL", label: "Gym – Lower, light" },
          { date: "2026-10-14", type: "run", label: "Easy run", targetKm: 9 },
          { date: "2026-10-15", type: "bike", label: "Rouvy Zone2", targetMin: 50 },
          { date: "2026-10-16", type: "stair", label: "Stairmaster, easy", targetMin: 25 },
          { date: "2026-10-16", type: "gymU", label: "Gym – Upper, light accessory" },
          { date: "2026-10-17", type: "swim", label: "Recovery swim", targetKm: 1.5 },
          { date: "2026-10-18", type: "long", label: "Long run, easy — absorb the load", targetKm: 17 },
        ],
      },
    ],
  },
    ...
    weeks: [
      {
        ...
        weeklyKmGoal: 61,
        sessions: [
          { date: "2026-10-19", type: "gymL", label: "Gym – Lower" },
          { date: "2026-10-20", type: "run", label: "Easy run", targetKm: 11 },
          { date: "2026-10-21", type: "bike", label: "Rouvy Zone2", targetMin: 75 },
          { date: "2026-10-22", type: "gymU", label: "Gym – Upper" },
          { date: "2026-10-23", type: "stair", label: "Stairmaster, repeats", targetMin: 50 },
          { date: "2026-10-23", type: "run", label: "Short easy run", targetKm: 4 },
          { date: "2026-10-24", type: "long", label: "Long run #1, moderate", targetKm: 27 },
          { date: "2026-10-25", type: "long", label: "Long run #2 (back-to-back), tired legs", targetKm: 20 },
        ],
      },
      {
        id: "w9",
        ...
        sessions: [
          ...
          { date: "2026-10-27", type: "gymL", label: "Gym – Lower" },
          { date: "2026-10-28", type: "run", label: "Easy run", targetKm: 11 },
          { date: "2026-10-29", type: "bike", label: "Rouvy Zone2", targetMin: 100 },
          { date: "2026-10-30", type: "stair", label: "Stairmaster, max vert this cycle", targetMin: 55 },
          { date: "2026-10-30", type: "gymU", label: "Gym – Upper, light accessory" },
          { date: "2026-10-31", type: "long", label: "Long run #1, trail — biggest run of the plan", targetKm: 37 },
          { date: "2026-11-01", type: "long", label: "Long run #2 (back-to-back), tired legs", targetKm: 25 },
        ],
      },
      {
        id: "w10",
        ...
        sessions: [
          ...
          { date: "2026-11-03", type: "gymL", label: "Gym – Lower, light" },
          { date: "2026-11-04", type: "run", label: "Easy run", targetKm: 9 },
          { date: "2026-11-05", type: "bike", label: "Rouvy Zone2", targetMin: 60 },
          { date: "2026-11-06", type: "gymU", label: "Gym – Upper" },
    ...
    weeks: [
      {
        ...
        sessions: [
          ...
          { date: "2026-11-10", type: "gymL", label: "Gym – Lower, light, low volume" },
          ...
          { date: "2026-11-13", type: "gymU", label: "Gym – Upper, light accessory" },
      ...
      },
      {
        ...
        sessions: [
          ...
          { date: "2026-11-19", type: "gymL", label: "Gym – light full body activation" },
